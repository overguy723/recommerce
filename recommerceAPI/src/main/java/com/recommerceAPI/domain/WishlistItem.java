...
@Table(name = "tbl_wishlist_item", indexes = {
        @Index(columnList = "wishlist_wno", name = "idx_wishlistitem_wishlist"),
        @Index(columnList = "product_pno, wishlist_wno", name="idx_wishlistitem_pno_wishlist")
})
...
public class WishlistItem {
  ...
  // 다대일 관계를 나타냄. 한 상품(Product)은 여러 카트 아이템에 속할 수 있음.
   @JoinColumn(name = "product_pno")
    ...
    @JoinColumn(name = "wishlist_wno")
    private Wishlist wishlist; // 연결된 카트.
